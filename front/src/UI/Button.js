...
const Button = ({isAdmin}) => {
    return (
        <div>
            {!isAdmin && <button className="button button1">
                <span className="button__text">
                    <span><span>C</span><span>h</span>e</span><span>c</span><span>k</span><span> </span><span>O</span><span>u</span><span>t</span><span>!</span>
                </span>
            ...
            {isAdmin && <button className="button" style={{ backgroundColor: '#dddddd' }} disabled>
                <span className="button__text">
                    <span><span>C</span><span>h</span>e</span><span>c</span><span>k</span><span> </span><span>O</span><span>u</span><span>t</span><span>!</span> <span style={{fontSize: '0.54rem'}}>(disable admin)</span>
                </span>
                <svg className="button__svg" role="presentational" viewBox="0 0 600 600">
                    <defs>
                    <clipPath id="myClip">
